	...
	return (
		<LazyMotion features={domAnimation}>
			<section id="tech" className="section">
				...
				{!!TECHNOLOGIES.length && (
					<div className="mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-14">
						{TECHNOLOGIES.map((tech, index) => {
							return (
								<div
									key={tech.category}
									ref={stackRef}
									className="flex flex-col gap-5 flex-1 md:flex-auto"
									style={{
								...
								>
									...
									<div className="flex items-center flex-wrap gap-x-5 gap-y-8">
										{tech.items.map((item) => (
											<div key={item.name} className="group relative flex opacity-80">
